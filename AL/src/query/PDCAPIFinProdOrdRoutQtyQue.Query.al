query 50021 "PDCAPI - FinProdOrdRoutQtyQue"
{
    Caption = 'Finished Prod.Order Routing Quantity Query', Locked = true;
    QueryType = API;
    APIPublisher = 'pdc';
    APIGroup = 'app1';
    APIVersion = 'v2.0';
    EntityName = 'finishedProdOrderRoutingQuantityQuery';
    EntitySetName = 'finishedProdOrderRoutingQuantityQueries';
