/// <summary>
/// Report PDC Portal - Order Confirm (ID 50021).
/// </summary>
Report 50021 "PDC Portal - Order Confirm"
{
    Caption = 'Portal - Order Confirmation';
    ProcessingOnly = true;
    ...
    begin
        ...
        SalesSetup.Get();
        if AttRec.Get(SalesSetup."PDC Order Conf. E-mail Body") then
