/// <summary>
/// Report PDCCreditMemo (ID 50045).
/// </summary>
Report 50045 "PDC Credit Memo"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/Layouts/PDCCreditMemo.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            dataitem(Line; "Sales Cr.Memo Line")
            {
                ...
                column(ProtexSKU; "PDC Protex SKU")
                {
                }
                column(ProtexSKU_Lbl; FieldCaption("PDC Protex SKU"))
                {
                }
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(DisplayAsmInformationFld; DisplayAssemblyInformation)
                    {
                        ApplicationArea = All;
                        Caption = 'Show Assembly Components';
                        ToolTip = 'Show Assembly Components';
                    }
                    field(DisplayShipmentInformationFld; DisplayShipmentInformation)
                    {
                        ApplicationArea = All;
                        Caption = 'Show Shipments';
                        ToolTip = 'Show Shipments';
                    }
                }
            }
        }
    ...
    var
        ...
        SalesPrepCreditMemoNoLbl: label 'Sales - Prepmt. Credit Memo %1', comment = '%1=document no.';
        ...
        TotalTextLbl: label 'Total %1', comment = '%1=Amount';
        TotalInclVATTextLbl: label 'Total %1 Incl. VAT', comment = '%1=Amount';
        SalesCreditMemoNoLbl: label 'Sales - Credit Memo %1', comment = '%1=document no.';
        TotalExclVATTextLbl: label 'Total %1 Excl. VAT', comment = '%1=Amount';
