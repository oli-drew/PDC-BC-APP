// /// <summary>
// /// Report PDC Import Stock R007 (ID 50041).
// /// </summary>
// Report 50041 "PDC Import Stock R007"
// {
//     Caption = 'Import Stock R007';
//     ProcessingOnly = true;
...
//                 SourceFileName := 'Stock/stockupdate.csv';
...
//                 //2 -open file,  parse InStr, read data into Item Vendor table                
//                 if GuiAllowed then begin
//                     window.Open('#1#############################################\' +
//                                 '#2#############################################');
//                     window.Update(1, StrSubstNo(ParseFileTxt, SourceFileName));
//                 end;
