/// <summary>
/// Page PDC Demand Plan Monthly Usage (ID 50055).
/// </summary>
page 50055 "PDC Demand Plan Monthly Usage"
{
    ...
    begin
        PeriodDate.Reset();
        PeriodDate."Period Type" := PeriodDate."period type"::Month;
        PeriodDate."Period Start" := CalcDate('<-CM>', WorkDate());
        ...
        for i := 1 to 18 do begin
            if i = 1 then
                ...
                PeriodDate.Next();
            TempDateMatrixPeriod[i] := PeriodDate;
            MatrixColumnCaptions[i] := PeriodDate."Period Name" + ' ' + Format(Date2dmy(PeriodDate."Period Start", 3));
        end;
    end;
    ...
    begin
        ...
        Result := PDCDemandPlanRegister.Demand;
        exit(true);
    end;
