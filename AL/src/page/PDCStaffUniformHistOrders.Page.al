/// <summary>
/// Page PDC Staff Uniform Hist. Orders (ID 50064).
/// </summary>
page 50064 "PDC Staff Uniform Hist. Orders"
{
    Caption = 'Orders';
    Editable = false;
    PageType = ListPart;
    SourceTable = "Sales Line";
    SourceTableView = where("Document Type" = filter(Order | "Credit Memo"),
                            Type = const(Item));
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(Type; SelectStr(Rec."Document Type".Asinteger() + 1, DocTypeCptLbl))
                {
                    ApplicationArea = All;
                    Caption = 'Type';
                    ToolTip = 'Type';
    ...
    var
        ...
        SalesShipNo: Code[20];
        DocTypeCptLbl: label 'Quote,Order,Invoice,Credit Memo,Blanket Order,Return Order', Comment = 'Quote,Order,Invoice,Credit Memo,Blanket Order,Return Order';
}
