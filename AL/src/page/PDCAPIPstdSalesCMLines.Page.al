/// <summary>
/// Page PDCAPI - Pstd Sales CM Lines (ID 50111).
/// </summary>
page 50113 "PDCAPI - Pstd Sales CM Lines"
{
    DelayedInsert = true;
    APIVersion = 'v2.0';
    EntityCaption = 'Posted Sales Credit Memo Line';
    EntitySetCaption = 'Posted Sales CM Lines';
    PageType = API;
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
