/// <summary>
/// TableExtension PDCSalesCrMemoHeader (ID 50021) extends Record Sales Cr.Memo Header.
/// </summary>
tableextension 50021 PDCSalesCrMemoHeader extends "Sales Cr.Memo Header"
{
    fields
    {
    ...
    begin
        ...
        PDCEmailManagementSetup.Get(SalesReceivablesSetup."PDC Credit Memo E-mail Setup", PDCEmailManagementSetup.Type::Setup, 0);
