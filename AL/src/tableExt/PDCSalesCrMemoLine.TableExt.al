/// <summary>
/// TableExtension PDCSalesCrMemoLine (ID 50022) extends Record Sales Cr.Memo Line.
/// </summary>
tableextension 50022 PDCSalesCrMemoLine extends "Sales Cr.Memo Line"
{
    fields
    {
    ...
    begin
        ...
        "PDC Document Id" := SalesCrMemoHeader.SystemId;
    end;
    ...
    begin
        ...
        if not SalesCrMemoHeader.GetBySystemId(Rec."PDC Document Id") then
            exit;
